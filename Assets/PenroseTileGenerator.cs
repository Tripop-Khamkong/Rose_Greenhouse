...
{   
    ...
    public PenroseTile CreateInitialTile()
    {
        ...
        GameObject tileObject = Instantiate(tilePrefab, Vector2.zero, Quaternion.identity, canvasTransform);
    ...
    public void GenerateTiles()
    {
        ...
        for (int iter = 0; iter < numIterations; iter++)
        {
            ...
            {
                GameObject tileObject = Instantiate(tilePrefab, tiles[i].center, Quaternion.identity, canvasTransform);
                tileObject.transform.localScale = new Vector3(tileScale, tileScale, 1f);
